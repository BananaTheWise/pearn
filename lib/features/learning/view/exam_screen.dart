...
/// Question index -> selected answer.
...
debugPrint(
'[UI][EXAM] Answer selected: "$answer"',
);
...
debugPrint(
  '[UI][EXAM] Exam submission requested',
);
...
final currentQuestion =
    exam.questions[_currentQuestionIndex];
...
Widget _buildTextAnswer(dynamic currentAnswer) {
return TextField(
